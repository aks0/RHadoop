 ...
 * <configuration>
 *   <property>
 *     <name>mapreduce.incrtextwriterdate.minwordskey</name>
 *     <value>5</value>
 *   </property>
 *   <property>
 *     <name>mapreduce.incrtextwriterdate.maxwordskey</name>
 *     <value>10</value>
 *   </property>
 *   <property>
 *     <name>mapreduce.incrtextwriterdate.minwordsvalue</name>
 *     <value>20</value>
 *   </property>
 *   <property>
 *     <name>mapreduce.incrtextwriterdate.maxwordsvalue</name>
 *     <value>100</value>
 *   </property>
 *   <property>
 *     <name>mapreduce.incrtextwriterdate.totalbytes</name>
 ...
 * 
 * To run: bin/hadoop jar hadoop-${version}-examples.jar incrtextwriterdate
 *            [-outFormat <i>output format class</i>] <i>output</i> 
 */
public class IncrementalTextWriterDate extends Configured implements Tool {
  public static final String TOTAL_BYTES = 
    "mapreduce.incrtextwriterdate.totalbytes";
  public static final String BYTES_PER_MAP = 
    "mapreduce.incrtextwriterdate.bytespermap";
  public static final String MAPS_PER_HOST = 
    "mapreduce.incrtextwriterdate.mapsperhost";
  public static final String MAX_VALUE = "mapreduce.incrtextwriterdate.maxwordsvalue";
  public static final String MIN_VALUE = "mapreduce.incrtextwriterdate.minwordsvalue";
  public static final String MIN_KEY = "mapreduce.incrtextwriterdate.minwordskey";
  public static final String MAX_KEY = "mapreduce.incrtextwriterdate.maxwordskey";
  
  static int printUsage() {
    System.out.println("incrtextwriterdate " +
  ...
  static class RandomTextMapper extends Mapper<Text, Text, Text, Text> {
    ...
    public int getMapperID (String mapper) {
    	String parts[] = mapper.split("_");
    	if (parts.length != 6 ||
    ...
    public void map(Text key, Text value,
      ...
      int itemCount = 0;
      String mapper = context.getTaskAttemptID().toString();
      int mapperid = getMapperID (mapper);
      year += mapperid * 10;
      ...
      while (numBytesToWrite > 0) {
        ...
        /* Akshay Mittal */
        Text keyWords = generateKey(mapperid);
        Text valueWords = generateSentence(noWordsValue);
        // Added a newline character at the beginning of key.
    ...
    /* Akshay Mittal */
    private Text generateKey (int mapperid) {
    	String key = "";
    	String fourDigit = "0000";
    	String twoDigit = "00";
    	DecimalFormat format4 = new DecimalFormat (fourDigit);
    	DecimalFormat format2 = new DecimalFormat (twoDigit);
    	
    	String[] bug = {"ERROR", "FATAL", "DEBUG", "INFO", "WARN"};
    	String info = bug[randBetween (0, 5)];
    	String KEY_FORMAT = "%s/%s/%s-%s:%s-%s";
    	
    	key = String.format(KEY_FORMAT,
    						format4.format(year),
		    				format2.format(month),
		    				format2.format(date), 
		    				format2.format(hour),
		    				format2.format(minute), info);
    	incrementParams ();
    	return new Text (key);
    }
	...
	/* Returns a random r s.t. (start <= r < end) */
  ...
  public int run(String[] args) throws Exception {    
    ...
    job.setJobName("random-text-writer-date");
    ...
    /* Akshay Mittal : SequenceFileOutputFormat => TextOutputFormat */
  ...
  public static void main(String[] args) throws Exception {
    int res = ToolRunner.run(new Configuration(),
    						 new IncrementalTextWriterDate(), args);
    System.exit(res);
  }
